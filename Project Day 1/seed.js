...
/*
In summary, this script provides a function (seedDB) that, when called, will insert the products array into the MongoDB database 
using the Product model. This is typically used to initialize the database with some initial data, 
making it easier to develop and test the application. */

/*  
    **************** Note : if we want to insert data within the same file then we only need to run this file . **************************
